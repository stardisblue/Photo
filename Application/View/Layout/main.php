...
<header class="main_header">
    <div class="header_wrapper">
        <div class="logo_sect">
            <a href="index.html" class="logo"><img src="<?= WEB_ROOT ?>/public/img/logo.png" alt=""  class="logo_def"><img src="img/retina/logo.png" alt="" class="logo_retina"></a>
                    ...
                    <ul id="menu-main-menu" class="menu">
                        ...
                        <li class="current-menu-parent menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="current-menu-item"><a href="404.html"><span>404 Error</span></a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children">
